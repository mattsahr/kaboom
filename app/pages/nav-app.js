...
(function () {
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div8, file$c, 93, 12, 3078);
    			attr_dev(div9, "class", "text");
    			add_location(div9, file$c, 100, 16, 3408);
    			...
    			add_location(div10, file$c, 98, 12, 3274);
    			attr_dev(div11, "class", "text");
    			add_location(div11, file$c, 105, 16, 3603);
    			...
    			add_location(div12, file$c, 103, 12, 3473);
    			attr_dev(div13, "class", "switch-spacer svelte-1bznl0s");
    			add_location(div13, file$c, 108, 12, 3666);
    			attr_dev(div14, "class", "list-switcher svelte-1bznl0s");
    			add_location(div14, file$c, 70, 4, 2159);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$c(ctx) {
    	...
    	let if_block = /*$shown*/ ctx[7] && create_if_block$4(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 68, 0, 2062);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$5(ctx) {
    	...
    	let if_block0 = /*currentItem*/ ctx[4] !== /*homeItem*/ ctx[7] && create_if_block_2(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (/*currentItem*/ ctx[4] !== /*homeItem*/ ctx[7]) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty & /*currentItem, homeItem*/ 144) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const navitem_changes = {};
    			if (dirty & /*currentItem*/ 16) navitem_changes.item = /*currentItem*/ ctx[4];
    			navitem.$set(navitem_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(98:8) {#if currentItem !== homeItem}",
    		ctx
    	});
    ...
    // (109:8) {#if $orderType === 'group'}
    function create_if_block_1$2(ctx) {
    	let navgroups;
    	let current;

    	navgroups = new NavGroups({
    			props: { navGroups: /*navGroups*/ ctx[5] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*navGroups*/ 32) navgroups_changes.navGroups = /*navGroups*/ ctx[5];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(109:8) {#if $orderType === 'group'}",
    		ctx
    	});
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$d, 92, 0, 2906);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$d($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, NavStore, $$value => $$invalidate(18, $NavStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	validate_store(sortDirection, "sortDirection");
    	component_subscribe($$self, sortDirection, value => $$invalidate(17, $sortDirection = value));
    	const activeSort = writable(sortMethods.date);
    	validate_store(activeSort, "activeSort");
    	component_subscribe($$self, activeSort, value => $$invalidate(16, $activeSort = value));
    	let current;
    	let categories = [];
    	...
    	const initOptions = () => {
    		$$invalidate(14, current = window.NAV_DATA.currentURL);
    		$$invalidate(15, categories = [...window.NAV_DATA.categories].sort());
    	...
    	$$self.$inject_state = $$props => {
    		if ("current" in $$props) $$invalidate(14, current = $$props.current);
    		...
    		if ("navGroups" in $$props) $$invalidate(5, navGroups = $$props.navGroups);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$NavStore, $sortDirection, $activeSort, current, $orderType, $active*/ 475141) {
    			 $$invalidate(1, navList = getList($NavStore.albums, $sortDirection, $activeSort, current));
    		}

    		if ($$self.$$.dirty & /*$NavStore, current*/ 278528) {
    			 $$invalidate(4, currentItem = $NavStore.albums.find(next => next.url === current));
    		}

    		if ($$self.$$.dirty & /*navList, categories*/ 32770) {
    			 $$invalidate(5, navGroups = composeNavGroups(navList, categories));
    		}
